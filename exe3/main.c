...
QueueHandle_t xQueueButId_R; // Fila para o botão e LED R
QueueHandle_t xQueueButId_G; // Fila para o botão e LED G
...
int main() {
    ...
    // Verificação se as filas foram criadas corretamente
